export const environment = {
  production: false,
  getway_seal: 'http://123.24.142.93:6508/', // api con dấu
  getwayHR: 'http://123.24.142.93:6511/hr/', // api lấy cây đơn vị, nhân viên
  getway_mail: 'http://123.24.142.93:6506/', // api thư
  getway_mo: 'http://123.24.142.93:6509/', // api lấy cây đơn vị, nhân viên
  root_organization: 196
};
